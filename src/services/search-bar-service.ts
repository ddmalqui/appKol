...
export class SearchBarService implements IService {
    ...
    getDataForLayout3iphone = (): any => {
        ...
        getDataForLayout3auriculares = (): any => {
        return {
            "headerImage": "assets/images/background/auriculares.jpeg",
            "items": [
                {
                    "id": 1,
                    "title": "Cable USB-C to Lightning",
...
getDataForLayout3parlantes = (): any => {
        return {
            "headerImage": "assets/images/background/parlantes.jpeg",
            "items": [
                {
                    "id": 1,
                    "title": "Cable USB-C to Lightning",
...
getDataForLayout3luces = (): any => {
        return {
            "headerImage": "assets/images/background/luces.jpeg",
            "items": [
                {
                    "id": 1,
                    "title": "Cable USB-C to Lightning",
...
getDataForLayout3juegos = (): any => {
        return {
            "headerImage": "assets/images/background/juegos.jpeg",
            "items": [
                {
                    "id": 1,
                    "title": "Cable USB-C to Lightning",
